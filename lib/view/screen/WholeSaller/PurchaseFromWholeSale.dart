...
class _PurchaseFromWholeSaleState extends State<PurchaseFromWholeSale> {
                      ...
                      Container(
                          ...
                          child: CustomButton(
                              onTap: () async {
                                ...
                                String cl_tax =
                                    _clinicTaxNoController.text.trim();
                                if (cl_img == null) {
                                  ...
                                  ScaffoldMessenger.of(context)
                                      .showSnackBar(SnackBar(
                                    content:
                                        Text('Registration number required '),
                                    backgroundColor: Colors.red,
                                  ));
                                } else if (have_tax_number == 'Yes' &&
                                    cl_tax.isEmpty) {
                                  ScaffoldMessenger.of(context)
                                      .showSnackBar(SnackBar(
  ...
  void getUserID() async {
    userID = await Provider.of<ProfileProvider>(context, listen: false)
        .getUserInfo(context);
    setState(() {
      userID;
    });
