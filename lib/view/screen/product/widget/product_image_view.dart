                            ...
                            child: Column(
                              children: [
                                Container(
                                  ...
                                  //sanwal
                                  child: Text(
                                    '${PriceConverter.percentageCalculation(context, apprived_as_whole_rate_purchaser ? productModel.purchasePrice : productModel.unitPrice, productModel.discount, productModel.discountType)}',
